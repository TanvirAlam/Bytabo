...
;(function ( $ ) {
    $.fn.turbotabs = function(options){
        ...
        var settings = $.extend({
            ...
            navBackground: '#003264',
            hoverColor: '#fff',
            hoverBackground: 'rgba(204,0,0,0.84)',
            activeBackground: 'rgba(204,0,0,0.84)',
            mode: 'horizontal',
            width: '100%',
            padding: '0%',
            animation: 'Scale',
        ...
        this.css({width: settings.width, padding: '5px ' + settings.padding});
        container.css({color: settings.norColor, background: settings.backgroundColor, fontsize: settings.fontSize});
